...
public class Socks5LineBasedFrameDecoder extends LocalByteToMessageDecoder {
     ...
     */
    public Socks5LineBasedFrameDecoder(final int maxLength) {
     ...
     */
    public Socks5LineBasedFrameDecoder(final int maxLength, final boolean stripDelimiter, final boolean failFast) {
     ...
     *
     * @param ctx    the {@link ChannelHandlerContext} which this {@link LocalByteToMessageDecoder} belongs to
    ...
    public static class Builder {
        private Socks5LineBasedFrameDecoder decoder;

        public Builder(int maxFrameLength) {
            decoder = new Socks5LineBasedFrameDecoder(maxFrameLength);
        }

        public Socks5LineBasedFrameDecoder.Builder setProxyState(boolean proxy) {
            decoder.mProxy = proxy;
            return this;
        }

        public Socks5LineBasedFrameDecoder build() {
            return decoder;
        }
    }
}
